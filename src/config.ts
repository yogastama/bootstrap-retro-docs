...
export const GITHUB_EDIT_URL = `https://github.com/yogastama/bootstrap-retro-docs/blob/master`;

export const COMMUNITY_INVITE_URL = `https://t.me/+FUfPrdvs7nJkNjFl`;
...
export const SIDEBAR: Sidebar = {
	en: {
		...
		'Components': [
			...
			{ text: 'Tooltips', link: 'en/components/tooltips' },
		],
	},
};
